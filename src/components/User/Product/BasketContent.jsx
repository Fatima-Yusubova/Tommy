...
const BasketContent = ({ basketItems, setBagOpen }) => {
  ...
  return (
    <div className="flex flex-col h-full max-h-screen">
      ...
      <div className="border-t border-t-gray-200 p-6 flex-shrink-0">
        ...
        <button className="w-full tracking-tighter text-[16px] bg-black text-[#9FA4A9] py-4 px-6 rounded-md font-medium mb-3">
          Review + Checkout
        </button>
